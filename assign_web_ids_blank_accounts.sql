            ...
            from
                  ...
                  from 
                        ...
                        (select student_number
                               ...
                               ,lastfirst
                               ,dob
                               ,student_web_id as cur_stu_web_id
                               ,student_web_password as cur_stu_web_password
                               ,enroll_status
                         from students s)))))
where cur_stu_web_id is null and enroll_status <= 0
order by enroll_status, student_web_id;