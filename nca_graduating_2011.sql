                 ...
                 (select base_studentid
                  ...
                  from
                      (select re.studentid as base_studentid
                       ...
                       where re.entrydate >= '01-AUG-07' and re.exitdate < '01-JUL-08' and (re.exitdate - re.entrydate) > 0 and re.schoolid = 73253) 
                  where rn = 1
                   union all
                  ...
                  from students
                  where students.entrydate > '01-AUG-07' and students.entrydate < '28-JUN-08'
                    and students.enroll_status > 0 and students.exitdate > '01-AUG-07' and students.schoolid = 73253
